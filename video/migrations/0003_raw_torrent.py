...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.raw_torrent'
        db.add_column(u'video', 'raw_torrent', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Video.raw_torrent'
        db.delete_column(u'video', 'raw_torrent')

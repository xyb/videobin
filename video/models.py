...
class Video(models.Model):
    ...
    encoding_status = models.TextField(blank=True)
    seeding = models.BooleanField(default=False)
    sha1 = models.CharField(max_length=120, blank=True)
    duration = models.IntegerField(default=-1)
    size = models.IntegerField(default=-1)
    video_codec = models.TextField(default='')
    video_bitrate = models.TextField(default='')
    framerate = models.TextField(default='')
    width = models.IntegerField(default=320)
    height = models.IntegerField(default=240)
    pixel_aspect_ratio = models.TextField(default='')
    audio_codec = models.TextField(default='')
    audio_bitrate = models.TextField(default='')
